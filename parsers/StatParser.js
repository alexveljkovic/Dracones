/*
PARSER CODE @pegjs.org
------------
Sections
  = sec1:Section (NL) {return sec1}
/ sec1:Section (_)(NL)(_) sec2:Section {return sec1.concat(sec2)}

Section
  = str:String (_ (":")) (NL) item:Item  {return [{section: str, items: item}]}

Item
  = (_(">")_) str:String (_ ";" _) prop:Property (NL) items:Item{return [{name: str, properties: prop}].concat(items)}
/ (_(">")_) str:String (NL) items:Item {return [{name: str, properties: []}].concat(items)}
/ (_(">")_) str:String{return [{name: str, properties: []}]}
/ _

Property
  = (_) key:String (_ (":") _) value:Expression (_ (",") (_)) props:Property {return [{key: key, expression: value }].concat(props)}
/ (_) key:String (_ (":") _) value:Expression (_) {return [{key: key, expression: value}]}
/ '' {return [] }
...
Dice
  = num:([0-9]+) "d" type:([0-9]+) { return {type: 'dice', num: num, diceType: `d${type}` }}

String "String"
  = str:([a-zA-Z0-9])+ { return text() }
